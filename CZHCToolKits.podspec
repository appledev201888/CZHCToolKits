...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/CZHCToolKits"
  ...
  s.source       = { :git => "https://github.com/appledev201888/CZHCToolKits.git", :tag => "#{s.version}" }
  ...
  s.vendored_libraries = 'Classes/DebugIQKeyboardTools.a'
